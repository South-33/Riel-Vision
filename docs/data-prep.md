...
- `data/review/cashsnap_p1_oldcommon_partial_focus_review_v1/`: ignored focused review queue generated by `scripts/build_partial_focus_review_queue.py`; it combines the high-confidence old/common failures with smallest partial crops from the Roboflow 5k/10k and 20k/50k packs for a smaller P1 curation pass.
