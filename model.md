...
- `--note-condition-policy` supports targeted condition curricula/audits: `mixed`, `pristine_only`, `heavy_wear`, and `wet_stress`; batch and catalog recipe wrappers forward it and record it in `recipe.json`.
