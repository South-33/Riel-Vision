...
- A fixed-step/order-stable model probe harness; current one-epoch tiny-dose results are sensitive to train-list row count and order, so matched row-count controls are mandatory until this is repaired.
