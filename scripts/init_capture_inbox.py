...
def guide_text(row: dict[str, str], folder_path: Path) -> str:
    ...
    return "\n".join(
        [
            ...
            "",
            "Drop raw, unannotated, rights-clear phone photos for this scene in this folder.",
            "Do not drop screenshots, prediction overlays, contact sheets, synthetic renders, or edited review crops.",
...
def root_guide_text(rows: list[dict[str, str]], out_dir: Path) -> str:
    ...
    return "\n".join(
        [
            ...
            "",
            "Drop raw, unannotated, rights-clear phone photos into the scene folders below.",
            "Do not drop screenshots, prediction overlays, contact sheets, synthetic renders, or edited review crops.",
            "Keep faces, IDs, cards, receipts, screens, and location details out of frame.",
            "",
            "Folders:",
