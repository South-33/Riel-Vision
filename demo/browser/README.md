...
Smoke note: the autorun shop-overlap URL loads the ONNX stack in Edge and predicts 6 bills, but the denomination total is still wrong (`KHR 56,000`, `USD 0` vs the draft-label total of `KHR 70,000`, `USD 0`). Current browser classes are `KHR_1000:1`, `KHR_5000:1`, `KHR_10000:3`, and `KHR_20000:1`; evaluating `.agent/cashsnap-browser-smoke-cdp.csv` against the draft labels gives `6/6` any-class matches and `3/6` same-class matches. Treat this as working browser plumbing, not solved counting.
